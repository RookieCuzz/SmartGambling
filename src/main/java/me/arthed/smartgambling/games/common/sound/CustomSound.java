...
/* 23 */       Bukkit.getScheduler().runTaskLater((Plugin)smartGambling, () -> player.playSound(player.getLocation(), soundElement.sound, soundElement.volume, soundElement.pitch), totalDelay);
/*    */     } 
/*    */   }
/*    */ }
