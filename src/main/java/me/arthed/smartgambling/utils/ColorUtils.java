...
/* 19 */     Pattern hexPattern = Pattern.compile(Pattern.quote(startTag) + "([A-Fa-f0-9]{6})" + Pattern.quote(endTag));
...
/* 25 */       matcher.appendReplacement(buffer, Matcher.quoteReplacement("§x§" + group
